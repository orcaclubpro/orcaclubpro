...
export const metadata: Metadata = {
  ...
  description: 'Epic 14-Day Japan Journey • November 4-17, 2024 - Interactive kaiju hunting trip planner',
  ...
  openGraph: {
    ...
    description: 'Epic 14-Day Japan Journey • November 4-17, 2024 - Kaiju Hunting Adventure',
    type: 'website',
  },
}
