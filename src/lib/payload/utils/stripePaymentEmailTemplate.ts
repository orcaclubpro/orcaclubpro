  ...
  const lineItemsHtml = order.lineItems
    ...
    <tr>
      <td style="padding: 10px 0; border-bottom: 1px solid #1a1a1a;">
        ...
        ${item.description ? `<div style="color: #3a3a3a; font-size: 12px; margin-top: 3px; font-weight: 300;">${item.description}</div>` : ''}
        ${
          item.isRecurring
      ...
      <td style="padding: 10px 0; border-bottom: 1px solid #1a1a1a; text-align: right; color: #555555; font-size: 13px; font-weight: 300;">
        $${item.unitPrice.toFixed(2)}${item.isRecurring ? `<span style="color: #3a3a3a; font-size: 11px;">/${item.recurringInterval}</span>` : ''}
      </td>
      <td style="padding: 10px 0; border-bottom: 1px solid #1a1a1a; text-align: right; color: #555555; font-size: 13px; font-weight: 300;">
        $${(item.unitPrice * item.quantity).toFixed(2)}${item.isRecurring ? `<span style="color: #3a3a3a; font-size: 11px;">/${item.recurringInterval}</span>` : ''}
      </td>
    </tr>
  `
    )
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:560px;width:100%;background-color:#080808;border:1px solid #111111;">
          ...
          <tr>
            <td style="padding:40px 40px 0 40px;">
              ...
              <!-- Eyebrow label -->
              <p style="margin:0 0 14px 0;font-size:10px;letter-spacing:0.35em;text-transform:uppercase;color:#3a3a3a;font-weight:400;">Order Ready</p>

              <!-- Heading -->
              <p style="margin:0;font-size:22px;font-weight:200;color:#ffffff;letter-spacing:0.01em;line-height:1.3;">Your payment link is ready.</p>
              ...
              <!-- Body copy -->
              <p style="margin:32px 0 0 0;font-size:13px;color:#555555;line-height:1.8;font-weight:300;">Thank you${order.customerName ? `, ${order.customerName}` : ''}. Your custom order has been prepared and is ready for secure payment through Stripe.</p>
          ...
          <tr>
            <td style="padding:20px 40px 0 40px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="background-color:#111111;border:1px solid #1a1a1a;border-left:3px solid #555555;padding:16px 20px;">
                    <p style="margin:0 0 6px 0;font-size:10px;letter-spacing:0.35em;text-transform:uppercase;color:#3a3a3a;font-weight:400;">Subscription Items Included</p>
                    <p style="margin:0;font-size:12px;color:#555555;line-height:1.7;font-weight:300;">This order includes recurring subscription items. You'll be charged automatically at each billing interval until you cancel.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:20px 40px 0 40px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="background-color:#111111;border:1px solid #1a1a1a;padding:16px 20px;">
                    <p style="margin:0 0 4px 0;font-size:10px;letter-spacing:0.35em;text-transform:uppercase;color:#3a3a3a;font-weight:400;">Secure Payment Processing</p>
                    <p style="margin:0;font-size:12px;color:#555555;line-height:1.7;font-weight:300;">Your payment is processed securely by Stripe. We never see or store your payment information. This link will remain active and you can return to it at any time.</p>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="border-top:1px solid #0f0f0f;padding-top:24px;">
                    <p style="margin:0;font-size:11px;color:#2e2e2e;line-height:1.7;font-weight:300;">Questions about your order? Reply to this email or visit <a href="https://orcaclub.pro" style="color:#2a6068;text-decoration:none;">orcaclub.pro</a></p>
                  </td>
                </tr>
              </table>
            </td>
