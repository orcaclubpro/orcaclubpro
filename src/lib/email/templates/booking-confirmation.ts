  ...
  const content = `
          ...
          <tr>
            <td style="padding: 0 0 14px 0;">
              <p class="oc-eyebrow" style="margin: 0; font-size: 10px; letter-spacing: 0.35em; text-transform: uppercase; color: #3a3a3a; font-weight: 400;">Consultation Request</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 0 4px 0;">
              <p class="oc-heading" style="margin: 0; font-size: 22px; font-weight: 200; color: #ffffff; letter-spacing: 0.01em; line-height: 1.3;">Request received.</p>
            </td>
          </tr>
          ...
          <tr>
            <td class="oc-detail-box-lborder" style="padding: 16px 20px; background-color: #111111; border: 1px solid #1a1a1a; border-left: 3px solid #67e8f9;">
              <p class="oc-detail-label" style="margin: 0 0 12px 0; font-size: 10px; font-weight: 600; color: #3a3a3a; text-transform: uppercase; letter-spacing: 0.35em;">Your Request</p>
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                ` : ''}
                <tr>
                  <td class="oc-detail-key" style="padding: 6px 0; font-size: 13px; color: #3a3a3a;">Requested Time</td>
                  <td class="oc-detail-val" style="padding: 6px 0; font-size: 13px; color: #555555; text-align: right;">${formattedDate} at ${formattedTime}</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 24px 0 0 0;">
              <p class="oc-eyebrow" style="margin: 0 0 12px 0; font-size: 10px; font-weight: 600; color: #3a3a3a; text-transform: uppercase; letter-spacing: 0.35em;">What Happens Next</p>
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td style="padding: 4px 0;">
                    <p class="oc-body-text" style="margin: 0; font-size: 13px; color: #555555; font-weight: 300;">• We review your project requirements</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 4px 0;">
                    <p class="oc-body-text" style="margin: 0; font-size: 13px; color: #555555; font-weight: 300;">• Confirm your appointment within 24 hours</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 4px 0;">
                    <p class="oc-body-text" style="margin: 0; font-size: 13px; color: #555555; font-weight: 300;">• Send calendar invite with meeting link</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 4px 0;">
                    <p class="oc-body-text" style="margin: 0; font-size: 13px; color: #555555; font-weight: 300;">• Connect to discuss your project</p>
                  </td>
                </tr>
              </table>
            </td>
