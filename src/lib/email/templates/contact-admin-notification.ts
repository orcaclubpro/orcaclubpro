  ...
  const content = `
          ...
          <tr>
            <td style="padding: 0 0 14px 0;">
              <p class="oc-eyebrow" style="margin: 0; font-size: 10px; letter-spacing: 0.35em; text-transform: uppercase; color: #3a3a3a; font-weight: 400;">Inbound Lead</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 12px 0 4px 0;">
              <p class="oc-heading" style="margin: 0; font-size: 22px; font-weight: 200; color: #ffffff; letter-spacing: 0.01em; line-height: 1.3;">${name}</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 0 4px 0;">
              <p class="oc-body-text" style="margin: 0; font-size: 13px; color: #555555; font-weight: 300;">${service}</p>
            </td>
          </tr>
          ...
          <tr>
            <td class="oc-detail-box-lborder" style="padding: 16px 20px; background-color: #111111; border: 1px solid #1a1a1a; border-left: 3px solid #67e8f9;">
              <p class="oc-detail-label" style="margin: 0 0 12px 0; font-size: 10px; font-weight: 600; color: #3a3a3a; text-transform: uppercase; letter-spacing: 0.35em;">Contact Information</p>
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="oc-detail-key" style="padding: 6px 0; font-size: 13px; color: #3a3a3a; width: 30%;">Name</td>
                  <td class="oc-detail-val" style="padding: 6px 0; font-size: 13px; color: #555555; text-align: right;">${name}</td>
                </tr>
                <tr>
                  <td class="oc-detail-key" style="padding: 6px 0; font-size: 13px; color: #3a3a3a;">Email</td>
                  <td class="oc-detail-val" style="padding: 6px 0; text-align: right;">
                ...
                <tr>
                  <td class="oc-detail-key" style="padding: 6px 0; font-size: 13px; color: #3a3a3a;">Submitted</td>
                  <td class="oc-detail-val" style="padding: 6px 0; font-size: 13px; color: #555555; text-align: right;">${timestamp} PST</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <!-- Message -->
          <tr>
            <td class="oc-detail-box" style="padding: 16px 20px; background-color: #111111; border: 1px solid #1a1a1a;">
              <p class="oc-detail-label" style="margin: 0 0 12px 0; font-size: 10px; font-weight: 600; color: #3a3a3a; text-transform: uppercase; letter-spacing: 0.35em;">Their Message</p>
              <p class="oc-body-text" style="margin: 0; font-size: 13px; line-height: 1.8; color: #555555; white-space: pre-wrap; font-weight: 300;">${message}</p>
            </td>
          </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td class="oc-footer-note-td" style="border-top: 1px solid #0f0f0f; padding-top: 24px;">
                    <p class="oc-muted" style="margin: 0; font-size: 11px; color: #2e2e2e; line-height: 1.7; font-weight: 300;"><span style="color: #555555; font-weight: 400;">Quick Action:</span> Reply to this email to contact ${firstName} directly at <a href="mailto:${email}" style="color: #2a6068; text-decoration: none;">${email}</a></p>
                  </td>
                </tr>
              </table>
            </td>
