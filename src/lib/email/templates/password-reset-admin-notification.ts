  ...
  const content = `
          ...
          <tr>
            <td style="padding:0 0 14px 0;">
              <p class="oc-eyebrow" style="margin:0;font-size:10px;letter-spacing:0.35em;text-transform:uppercase;color:#3a3a3a;font-weight:400;">Security Event</p>
            </td>
          </tr>
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      ...
                      <tr>
                        <td class="oc-detail-key" style="padding:5px 0;font-size:13px;color:#3a3a3a;">Reset at</td>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td class="oc-footer-note-td" style="border-top:1px solid #0f0f0f;padding-top:24px;">
                    <p class="oc-muted" style="margin:0;font-size:11px;color:#2e2e2e;line-height:1.7;font-weight:300;">This client successfully reset their ORCACLUB password. If this was unexpected, reach them at <a href="mailto:${clientEmail}" style="color:#2a6068;text-decoration:none;">${clientEmail}</a>.</p>
                  </td>
                </tr>
              </table>
            </td>
