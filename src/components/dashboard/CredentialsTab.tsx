      ...
      <div className="px-4 pt-4 pb-3 flex items-start gap-3">
        ...
        {!readOnly && (
          <div className="flex items-center gap-0.5 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
            <button
              onClick={onEdit}
              className="size-6 flex items-center justify-center rounded-md text-[var(--space-text-muted)] hover:text-[var(--space-text-secondary)] hover:bg-[var(--space-bg-card-hover)] transition-all"
            >
            ...
            {canDelete && (
              <button
                onClick={onDelete}
                className="size-6 flex items-center justify-center rounded-md text-[var(--space-text-muted)] hover:text-red-400 hover:bg-red-400/[0.08] transition-all"
              >
...
function DeleteConfirmModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[var(--space-bg-base)] border-[var(--space-border-hard)] sm:max-w-[25rem] p-6 gap-4">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        {unlocked && (
          <button
            onClick={handleLock}
            className="flex items-center gap-1 text-[0.625rem] text-[var(--space-text-muted)] hover:text-red-400 transition-colors font-medium"
            title="Lock vault"
          >
