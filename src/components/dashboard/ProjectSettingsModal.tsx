  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      {!isControlled && (
        <DialogTrigger asChild>
          <Button
            variant="outline"
            size="lg"
            className="group bg-[var(--space-bg-card)] border-[var(--space-border-hard)] hover:bg-[var(--space-bg-card-hover)] hover:border-[rgba(139,156,182,0.15)] transition-all duration-300"
          >
      ...
      <DialogContent className="bg-transparent border-0 max-w-5xl p-0 overflow-hidden h-[85vh] shadow-[0_0_60px_rgba(255,255,255,0.06)]">
        ...
        <div className="flex h-full min-h-0 bg-[var(--space-bg-base)] rounded-[inherit] overflow-hidden">

          {/* ── LEFT PANEL ── atmospheric, informational */}
          <div className="relative hidden lg:flex w-[38%] flex-col bg-[var(--space-bg-card)] overflow-hidden border-r border-[var(--space-border-hard)]">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
              ...
              >
                <circle cx="210" cy="210" r="209" stroke="var(--space-divider)" strokeWidth="1" />
                <circle cx="210" cy="210" r="158" stroke="var(--space-divider)" strokeWidth="0.5" />
                <circle cx="210" cy="210" r="95" stroke="var(--space-divider)" strokeWidth="0.5" />
                <line x1="210" y1="0" x2="210" y2="420" stroke="var(--space-divider)" strokeWidth="0.5" />
                <line x1="0" y1="210" x2="420" y2="210" stroke="var(--space-divider)" strokeWidth="0.5" />
                <circle cx="210" cy="210" r="3" stroke="var(--space-divider)" strokeWidth="0.5" fill="none" />
                <line x1="210" y1="1" x2="210" y2="18" stroke="var(--space-divider)" strokeWidth="1" />
                <line x1="210" y1="402" x2="210" y2="419" stroke="var(--space-divider)" strokeWidth="1" />
                <line x1="1" y1="210" x2="18" y2="210" stroke="var(--space-divider)" strokeWidth="1" />
                <line x1="402" y1="210" x2="419" y2="210" stroke="var(--space-divider)" strokeWidth="1" />
              </svg>
            </div>
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center px-10">
              ...
              {totalTasks > 0 ? (
                <div className="space-y-6">
                  ...
                  <div className="h-px w-full bg-[var(--space-divider)] rounded-full overflow-hidden flex">
                    {completedTasks > 0 && (
                      <div
                  ...
                  <div className="space-y-3.5">
                    {[
                      { label: 'Total Tasks', value: totalTasks, color: 'text-[var(--space-text-primary)]' },
              ...
              <div className="relative z-10 px-10 pb-10 pt-6 border-t border-[var(--space-border-hard)]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-[var(--space-text-tertiary)] truncate">{clientAccount.name}</p>
                    <p className="text-xs text-[var(--space-text-secondary)] truncate">{clientAccount.email}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            >
              <svg width="72" height="72" viewBox="0 0 72 72" fill="none" className="opacity-[0.08]">
                <path d="M72 0 L72 72 L0 72" stroke="var(--space-divider)" strokeWidth="1" />
                <path d="M72 22 L72 72 L22 72" stroke="var(--space-divider)" strokeWidth="0.5" />
              </svg>
            </div>
          </div>
          ...
          <div className="flex-1 bg-[var(--space-bg-base)] flex flex-col min-h-0 overflow-hidden">
            ...
            >
              ...
              <section className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="proj-name" className="text-xs text-[var(--space-text-tertiary)] tracking-wide">
                  ...
                  <Input
                    ...
                    className="bg-[var(--space-bg-card)] border-[var(--space-border-hard)] text-[var(--space-text-primary)] focus:border-[rgba(139,156,182,0.15)] focus-visible:ring-0 placeholder:text-[var(--space-text-muted)]"
                    disabled={isLoading}
                    required
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="proj-description" className="text-xs text-[var(--space-text-tertiary)] tracking-wide">
                    Description
                  </label>
                  <Textarea
                    id="proj-description"
                    ...
                    className="bg-[var(--space-bg-card)] border-[var(--space-border-hard)] text-[var(--space-text-primary)] placeholder:text-[var(--space-text-muted)] focus:border-[rgba(139,156,182,0.15)] focus-visible:ring-0 resize-none"
                    disabled={isLoading}
                  />
                </div>
              </section>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        status === option.value
                          ...
                          : 'bg-[var(--space-bg-card)] text-[var(--space-text-muted)] hover:bg-[var(--space-bg-card-hover)] hover:text-[var(--space-text-secondary)] border border-[var(--space-border-hard)]'
                      )}
                    >
                      <span
                        className={cn(
              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="proj-start" className="text-xs text-[var(--space-text-tertiary)] tracking-wide">
                      Start Date
                    </label>
                    <Input
                      id="proj-start"
                      ...
                      className="bg-[var(--space-bg-card)] border-[var(--space-border-hard)] text-[var(--space-text-primary)] focus:border-[rgba(139,156,182,0.15)] focus-visible:ring-0 [color-scheme:light]"
                      disabled={isLoading}
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label htmlFor="proj-end" className="text-xs text-[var(--space-text-tertiary)] tracking-wide">
                      Target End
                    </label>
                    <Input
                      id="proj-end"
                  ...
                  {status === 'completed' && (
                    <div className="space-y-1.5 col-span-2">
                      <label
                        ...
                        className="text-xs text-[var(--space-text-tertiary)] tracking-wide"
                      >
                        Actual End Date
                      </label>
                      <Input
              ...
              <section className="space-y-4">
                ...
                <div className="flex gap-3">
                  <div className="flex-1 relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--space-text-muted)] text-sm font-medium pointer-events-none select-none">
                      {currencySymbol}
                    </span>
                    <Input
                      id="proj-budget"
                      ...
                      placeholder="0.00"
                      className="bg-[var(--space-bg-card)] border-[var(--space-border-hard)] text-[var(--space-text-primary)] pl-7 placeholder:text-[var(--space-text-muted)] focus:border-[rgba(139,156,182,0.15)] focus-visible:ring-0"
                      disabled={isLoading}
                    />
                  </div>
                  <Select
                    ...
                    disabled={isLoading}
                  >
                    <SelectTrigger className="w-24 bg-[var(--space-bg-card)] border-[var(--space-border-hard)] text-[var(--space-text-secondary)] focus:border-[rgba(139,156,182,0.15)] focus:ring-0">
                      <SelectValue />
                    </SelectTrigger>
                ...
                {!showDeleteZone ? (
                  ...
                  <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-5 space-y-4 animate-in fade-in slide-in-from-bottom-1 duration-200">
                    ...
                    <Input
                      ...
                      className="bg-[var(--space-bg-card)] border-red-500/20 text-[var(--space-text-primary)] placeholder:text-[var(--space-text-muted)] focus:border-red-400/40 focus-visible:ring-0 font-mono text-sm"
                      disabled={isDeleting}
                    />
                    {deleteError && (
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={isDeleting}
                        className="flex-1 text-xs text-[var(--space-text-muted)] hover:text-[var(--space-text-secondary)] bg-[var(--space-bg-card)] hover:bg-[var(--space-bg-card-hover)] border border-[var(--space-border-hard)] rounded-lg px-3 py-2 transition-all duration-150"
                      >
                        Cancel
                      </button>
                      <button
            ...
            <div className="px-10 pb-8 pt-5 border-t border-[var(--space-border-hard)] flex-shrink-0 space-y-4">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  disabled={isLoading}
                  className="flex-1 text-[var(--space-text-muted)] hover:text-[var(--space-text-secondary)] hover:bg-[var(--space-bg-card-hover)] border border-[var(--space-border-hard)] transition-all duration-200"
                >
