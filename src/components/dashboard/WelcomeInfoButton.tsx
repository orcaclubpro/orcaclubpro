...
export function WelcomeInfoButton({ firstName, showTips }: WelcomeInfoButtonProps) {
  ...
  const modal = open && (
    ...
    >
      ...
      >
        <div
          className="relative w-full max-w-[340px] rounded-2xl border border-white/[0.10] bg-[#111] shadow-2xl overflow-hidden"
        ...
        >
          ...
          <div className="p-5 space-y-4">
            ...
            >
              ...
              <button
                onClick={closeModal}
                className="p-1.5 text-gray-600 hover:text-gray-300 rounded-lg hover:bg-white/[0.06] transition-colors shrink-0 mt-0.5"
                aria-label="Close"
              >
            ...
            >
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl border border-white/[0.07] bg-white/[0.02] hover:border-blue-500/25 hover:bg-blue-500/[0.04] transition-all duration-150 text-left group"
              >
                <FolderOpen className="size-3.5 text-gray-500 group-hover:text-blue-400 transition-colors shrink-0" />
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-white">Track milestones &amp; sprints</p>
                  <p className="text-[10px] text-gray-600 mt-0.5">View your project progress</p>
                </div>
                <ArrowRight className="size-3 text-gray-600 group-hover:text-blue-400 transition-colors shrink-0" />
              </button>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl border border-white/[0.07] bg-white/[0.02] hover:border-blue-500/25 hover:bg-blue-500/[0.04] transition-all duration-150 text-left group"
              >
                <Receipt className="size-3.5 text-gray-500 group-hover:text-blue-400 transition-colors shrink-0" />
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-white">View and pay invoices</p>
                  <p className="text-[10px] text-gray-600 mt-0.5">Manage your payments</p>
                </div>
                <ArrowRight className="size-3 text-gray-600 group-hover:text-blue-400 transition-colors shrink-0" />
              </button>
            ...
            {/* ── Don't show again ─────────────────────────────────────────── */}
            <div
              className="flex items-center gap-2.5 pt-1 border-t border-white/[0.06]"
              style={{
                opacity: visible ? 1 : 0,
            ...
            >
              <button
                ...
                className={`flex items-center justify-center size-4 rounded border-2 shrink-0 transition-all duration-150 ${
                  dontShow
                    ...
                    : 'bg-transparent border-white/[0.22] hover:border-white/40'
                }`}
              ...
              <span
                className="text-[10px] text-gray-500 select-none cursor-pointer"
                onClick={() => setDontShow(v => !v)}
              >
                Don&apos;t show again
              </span>
  ...
  return (
    <>
      ...
      <button
        onClick={openModal}
        className="flex items-center justify-center size-7 rounded-full bg-blue-500/15 border border-blue-500/30 hover:bg-blue-500/25 hover:border-blue-500/50 hover:shadow-[0_0_10px_rgba(59,130,246,0.25)] transition-all duration-200 focus:outline-none shrink-0"
