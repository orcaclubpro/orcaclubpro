...
export type ScrollSpySection = {
  /** Must match the DOM id of the section it targets. */
  id: string
  label: string
...
/**
 * Prop-driven scroll-spy side rail — the DevelopmentSideNav pattern made
 * reusable. Desktop-only (hidden below lg), sticky, IntersectionObserver
 * drives the active dot.
 */
export function ScrollSpyNav({
  ...
  /** Footer link under the rail; pass null to omit. */
