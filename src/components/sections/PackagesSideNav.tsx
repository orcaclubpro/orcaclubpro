...
const sections = [
  { id: "section-packages",    name: "Packages",        sub: "3 tiers" },
  { id: "section-comparison",  name: "What's Included", sub: "Feature matrix" },
  { id: "section-maintenance", name: "Maintenance",     sub: "Monthly plans" },
  { id: "section-faq",         name: "FAQ",             sub: "8 questions" },
]

export default function PackagesSideNav() {
  const [activeId, setActiveId] = useState("section-packages")
